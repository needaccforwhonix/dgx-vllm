#!/usr/bin/env python3
"""Baseline Marlin + MTP benchmark (no v7 sparse) for comparison."""
...
logger = logging.getLogger("baseline_mtp")
...
def main():
    ...
    logger.info("Loading model with Marlin + MTP (no sparse)...")
    t0 = time.time()
    ...
    logger.info(f"\n  Marlin+MTP baseline average: {avg_tok_s:.1f} tok/s")
    logger.info("DONE")
